...
namespace ConfigureAppIo.Demos.SayHello.FullySeparatedStartupClean.Infra
{
    public class SayHelloFactory : ISayHelloFactory
    {
        ...
        public SayHelloFactory(IEnumerable<ISayHello> implementations)
        {
